...
from load_utils import load_gt_us, fpv_evs_iterator
from eval_utils import assert_eval_config, run_voxel
from eval_utils import log_results, write_raw_results, compute_median_results
    ...
    for i, scene in enumerate(scenes):
        ...
        if not has_gt:            
            ...
            for trial in range(trials):
                ...
                hyperparam = (train_step, net, dataset_name, scene, trial, args, max_nedges)
